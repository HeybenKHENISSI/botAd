 ...
 * @property {number} [unMuteTime='1'] Time in minutes to wait until unmuting a user. 0=never.
...
class AntiSpamClient extends EventEmitter {
	...
	constructor (options) {
		...
		this.options = {
			...
			unMuteTime: options.unMuteTime || 0.5,
	...
	async muteUser (message, member, spamMessages) {
		...
		/*setTimeout(function(){
			message.member.roles.remove(role, 'Spamming')
			a1 =1
			console.log(a1)
		}, 5000);*/
		return true
	...
	async warnUser (message, member, spamMessages) {
		console.log("gyugug")
		/*if(a1 == 1){
			this.cache.warnedUsers.pop(message.author.id)
			a1 =0
			console.log(a1)
		}*/
		//else{
	...
	async timeMute(member, message, role) {
		console.log("time")
		console.log(this.options.unMuteTime)
